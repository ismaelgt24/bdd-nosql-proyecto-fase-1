...
describe("Consultas", () => {
  ...
  test("Consulta 2: Devuelve un array con juegos lanzados entre fechas, de n empresas", async () => {
    const empresas = ["Treyarch", "Nintendo", "Hazelight"]; // Agregar empresas a esta lista, por ejemplo ['Nintendo', 'Activision', 'EA']
    const fechaInicio = "01/01/2010"; // Agregar fecha por ejemplo 1/10/2012
  ...
  test("Consulta 3: Devuelve un array con juegos lanzados disponibles en más de n plataformas y plataformas", async () => {
    const cantidadDePlataformas = 12; // Agregar un numero, por favor que sea mas de 1
  ...
  test("Consulta 4: Retorna juegos por n empresas desarrolladoras con valoración mayor a x", async () => {
    const empresas = ["Rockstar North", "Nintendo", "OVERKILL Software"]; // Agregar empresas a esta lista, por ejemplo ['Nintendo', 'Activision', 'EA']
    const valoracion = 4; // Agregar un numero, por ejemplo 7.3
  ...
  test("Consulta 5: Retorna juegos con una calificación mayor al promedio y que tengan mas de n generos", async () => {
    const cantidadDeGeneros = 4; // Agregar un numero, por ejemplo 3
  ...
  test("Consulta 6: Retorna juegos con etiquetas específicas y ordenados por fecha de lanzamientos", async () => {
    const etiquetas = ["Multiplayer", "Open World", "cooperative", "Tactical"]; // Agregar empresas a esta lista, por ejemplo ['Multiplayer', 'Singleplayer']
  ...
  test("Consulta 7: Retorna un array con los generos y su valoracion promedi.", async () => {
    const generos = ["Shooter", "Puzzle"]; // Agregar generos a esta lista, por ejemplo ['Action', 'Adventure', 'FPS']
  ...
  test("Consulta 8: Retorna un array de juegos con la palabra clave en su nombre", async () => {
    const palabra = "Andreas"; // Agregar una palabra como por ejemplo 'WAR'
  ...
  test("Consulta 10: Retorna juegos por géneros y plataformas con proyección de campos", async () => {
    const generos = ["Action", "RPG", "Platformer"]; // Agregar generos a esta lista, por ejemplo ['Action', 'Adventure', 'FPS']
    const plataformas = ["iOS"]; // Agregar empresas a esta lista, por ejemplo ['Nintendo', 'Activision', 'EA']
